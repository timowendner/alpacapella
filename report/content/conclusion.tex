\section{Conclusion}
This research investigates whether existing beat tracking algorithms can predict beats on rap acapella. While the absence of clear onsets and the rhythmic complexity of rap present challenges, the results demonstrates that the current state of the art models can predict beats for rap acapellas.
