...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.45\textwidth]{img/dataset_topk.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.45\textwidth]{img/dataset_bpm.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.45\textwidth]{img/dataset_lag.png}
